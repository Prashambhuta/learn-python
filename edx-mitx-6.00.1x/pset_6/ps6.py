...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        # defining the the result dict variable
        ...
        highcase_map = dict(zip([x for x in string.ascii_uppercase],
                                [n + 1 for n in range(len(string.ascii_uppercase))]))
    ...
    def decrypt_message(self):
        ...
        while shift < 26:
            ...
            for word in shifted_text.split(' '):
                if is_word(word_list, word.lower()):
                    max_words += 1
...
encrypred_story = CiphertextMessage(get_story_string())
print(encrypred_story.decrypt_message())