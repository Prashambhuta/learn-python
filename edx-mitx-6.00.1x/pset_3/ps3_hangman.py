...
def getAvailableLetters(lettersGuessed):
    ...
    return ''.join([x for x in letters if x not in lettersGuessed])
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the
    ...
    while guesses != 0:
        ...
        print("Available letters: ", getAvailableLetters(lettersGuessed=lettersGuessed))
        ...
        if user_guess in lettersGuessed:
            ...
            if user_guess in secretWord:
                print("Good Guess: ",
                      getGuessedWord(secretWord, lettersGuessed=lettersGuessed))
            else:
